...
<head>
    ...
    * {
    ...
    .produk {
        ...
        /* Gambar berada di tengah jika hanya ada satu gambar */
        gap: 20px;
    }
    ...
    @media (min-width: 768px) {
        ...
        .produk {
            justify-content: center;
            /* Gambar tetap terpusat di layar besar */
            margin: 0 auto;
            /* Pastikan margin di kedua sisi kontainer gambar */
            padding: 0;
            /* Menghapus padding yang tidak diinginkan */
        }

        .produk img {
            max-width: 30%;
            /* Gambar akan lebih kecil di layar besar */
        }
    }
...
<body>
    ...
    <section id="alamat" class="section">
        <div class="mt-5">
            <h3 class="text-center mb-4">Lokasi Toko Offline</h3>
