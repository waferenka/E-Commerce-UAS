...
--
-- Host: localhost
-- Generation Time: Jan 12, 2025 at 12:49 PM
...
(1, 4, 'Tri Ambar Ningtias', 5, 'Whiskas - Makanan Kucing', 1, 28000.00),
(2, 4, 'Tri Ambar Ningtias', 13, 'Royal Canin 2KG - Makanan Kucing', 1, 250000.00);
...
--
-- Table structure for table `districts_palembang`
--

CREATE TABLE `districts_palembang` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `districts_palembang`
--

INSERT INTO `districts_palembang` (`id`, `name`, `latitude`, `longitude`) VALUES
(1, 'Alang-alang Lebar', -2.91380000, 104.69690000),
(2, 'Bukit Kecil', -2.99120000, 104.76120000),
(3, 'Gandus', -3.03000000, 104.72540000),
(4, 'Ilir Barat I', -2.97970000, 104.74440000),
(5, 'Ilir Barat II', -3.01330000, 104.73560000),
(6, 'Ilir Timur I', -2.99260000, 104.76570000),
(7, 'Ilir Timur II', -3.00080000, 104.77900000),
(8, 'Kalidoni', -2.97280000, 104.80130000),
(9, 'Kertapati', -3.02240000, 104.74800000),
(10, 'Kemuning', -2.97050000, 104.76040000),
(11, 'Plaju', -2.99300000, 104.80560000),
(12, 'Sako', -2.93040000, 104.78020000),
(13, 'Seberang Ulu I', -3.01110000, 104.75460000),
(14, 'Seberang Ulu II', -3.02420000, 104.73820000),
(15, 'Sukarami', -2.91840000, 104.72270000),
(16, 'Sematang Borang', -2.95250000, 104.80500000);
...
INSERT INTO `shipping_detail` (`id`, `order_id`, `status_pengiriman`) VALUES
(4, '1998468678', 2);
...
(3, 'Pesanan telah dikonfirmasi, menunggu pesan dikirim'),
(4, 'Pesanan sedang dikirim'),
(5, 'Pesanan telah diterima pembeli'),
(6, 'Pesanan Dibatalkan Penjual'),
(7, 'Pesanan dibatalkan pembeli');
...
INSERT INTO `transactions` (`transaction_id`, `user_id`, `order_id`, `transaction_status`, `gross_amount`, `payment_time`, `update_time`, `item_details`) VALUES
(6, 4, '1998468678', 'success', 278000.00, '2025-01-12 06:39:59', '2025-01-12 06:40:27', '[{\"id\":\"5\",\"price\":\"28000\",\"quantity\":\"1\",\"name\":\"Whiskas - Makanan Kucing\"},{\"id\":\"13\",\"price\":\"250000\",\"quantity\":\"1\",\"name\":\"Royal Canin 2KG - Makanan Kucing\"}]');
...
(4, 'imgs/user/ambar_gmail_com.jpg\r\n', 'Perempuan', '1994-04-07', 'Jl. Contoh No. 4', '08123456781');
...
--
-- Indexes for table `districts_palembang`
--
ALTER TABLE `districts_palembang`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `districts_palembang`
--
ALTER TABLE `districts_palembang`
